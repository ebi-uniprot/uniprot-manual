...
![protnlm-UNProtein input-output figure.png](https://github.com/ebi-uniprot/uniprot-manual/blob/main/images/protnlm-UNProtein%20input-output%20figure.png)
...
![protnlm-UNProtein with organism input-output figure.png](https://github.com/ebi-uniprot/uniprot-manual/blob/main/images/protnlm-UNProtein%20with%20organism%20input-output%20figure.png)
...
![protnlm-UNProtein with secondary structure input-output figure.png](https://github.com/ebi-uniprot/uniprot-manual/blob/main/images/protnlm-UNProtein%20with%20secondary%20structure%20input-output%20figure.png)
...
![protnlm-UNProtein ensemble input-output figure.png](https://github.com/ebi-uniprot/uniprot-manual/blob/main/images/protnlm-UNProtein%20ensemble%20input-output%20figure.png)
...
![protnlm-UNProtein evidence via alignment figure.png](https://github.com/ebi-uniprot/uniprot-manual/blob/main/images/protnlm-UNProtein%20evidence%20via%20alignment%20figure.png)
...
1. [Add the sequence D2GX75 to the basket](https://github.com/ebi-uniprot/uniprot-manual/blob/main/images/protnlm-4-pandasquencessorted%20by%20length.png),
...
3. Select the proteins to compare protein D2GX75 with, e.g. [all reviewed entries named "Adhesion G protein-coupled receptor V1"](https://github.com/ebi-uniprot/uniprot-manual/blob/main/images/protnlm-7-selection%20of%20SwissProt.png), and [add them to the basket containing already the original protein D2GX75](https://github.com/ebi-uniprot/uniprot-manual/blob/main/images/protnlm-8-basket%20function.png),
4. [Perform sequence alignment](https://github.com/ebi-uniprot/uniprot-manual/blob/main/images/protnlm-9-alignment%20part%201.png), and [examine the resulting alignment](https://github.com/ebi-uniprot/uniprot-manual/blob/main/images/protnlm-10-alignment%20part%202.png). For instance, in this case, a distinguishing property of G protein-coupled receptors (GPCRs) is that [they contain 7 transmembrane domains](https://github.com/ebi-uniprot/uniprot-manual/blob/main/images/protnlm-12-G-protein%20couples%20receptors.png), so one can use [UniProt website's ability to highlight the transmembrane regions](https://github.com/ebi-uniprot/uniprot-manual/blob/main/images/protnlm-11-alignment%20part%203_with%20transmembrane%20annotation.png) to [assess whether the transmembrane domains are conserved across the proteins compared](https://github.com/ebi-uniprot/uniprot-manual/blob/main/images/protnlm-13-alignment%20part%203_conservation%20of%20transmembrane%20domains.png).
