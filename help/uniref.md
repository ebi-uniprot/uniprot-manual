...
In addition to UniProtKB records, UniRef100 also includes the UniParc entries that are not covered by UniProtKB and contain cross-references to the [RefSeq](https://www.ncbi.nlm.nih.gov/refseq/) or [PDB](https://www.wwpdb.org/) databases.
...
- UniRef Publication [Suzek B.E. et al. (2014)](https://bioinformatics.oxfordjournals.org/content/31/6/926.full)
