...
Dr. Ross joined the Protein Information Resource (PIR) research team in 2015 as a Senior Bioinformatics Scientist. She has played a key role in several knowledge resource projects, including curation, data integration, user interface design, and development of biological use cases. In her role as a medical educator, she has taught workshops on UniProt at Georgetown and the NIH Foundation for Advanced Education in the Sciences (FAES). In UniProt, she is involved in co-hosting the community engagement workshops, conducting usability tests, analyzing the needs of users and collaborating resources, and developing training and outreach activities. She also assists with biocuration activities, including integration of curated data from external resources such as iPTMnet into UniProt, and identify and evaluate new sources of bibliography for the UniProt additional bibliography.
