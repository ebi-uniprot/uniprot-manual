...
The [Controlled vocabulary of plasmids](https://ftp.ebi.ac.uk/pub/databases/uniprot/current_release/knowledgebase/complete/docs/plasmid.txt) lists the currently valid values for the plasmids cited in the [Encoded in](https://www.uniprot.org/help/encoded_in) subsection of the 'Names and origin' section and in the [cross-references](https://www.uniprot.org/help/cross_references_section) section of UniProtKB/Swiss-Prot entries.
