...
-   [delac\_sp.txt](https://ftp.uniprot.org/pub/databases/uniprot/knowledgebase/docs/delac_sp.txt) for deleted ACs in UniProtKB/Swiss-Prot
-   [delac\_tr.txt.gz](https://ftp.uniprot.org/pub/databases/uniprot/knowledgebase/docs/delac_tr.txt.gz) for deleted ACs in UniProtKB/TrEMBL
