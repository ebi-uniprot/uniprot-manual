...
These proteomes can be queried and downloaded from the [Proteomes](https://www.uniprot.org/proteomes) section of the UniProt website. [UniProtKB](https://www.uniprot.org/help/uniprotkb) entries that are part of a proteome have a cross-reference to their proteome.
