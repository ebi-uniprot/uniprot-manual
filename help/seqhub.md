...
![SeqHub overview](../images/Seqhub-fullview.png)
...
![Surrounding genes](<../images/Seqhub-iframe_surrounding genes.png>)
...
![Percent identity and percent coverage](../images/Seqhub-iframe_ID.png)
...
![Functional annotations on mouse hover](../images/Seqhub-iframe_hover_annotation.png)

**5\. Taxonomic lineage** Each row lists the full taxonomic lineage of the organism the contig comes from.

![Taxonomic lineage](../images/Seqhub-iframe_taxonomic_lineage.png)
...
![Link to SeqHub for more results](../images/Seqhub-iframe_results.png)
