...
The taxonomy classification is maintained at the [NCBI](https://www.ncbi.nlm.nih.gov/taxonomy) and is used by the nucleotide sequence databases (EMBL/GenBank/DDBJ).
