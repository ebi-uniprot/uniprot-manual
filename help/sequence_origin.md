...
- the [PDB](https://www.wwpdb.org/) database.
...
- sequences scanned from the literature (i.g. [PRF](https://www.genome.jp/dbget-bin/www_bfind?prf) or other journal scan project).
- sequences derived from gene prediction, not submitted to EMBL-Bank/GenBank/DDBJ ([Ensembl](https://www.ensembl.org/), [Ensembl Genomes](https://ensemblgenomes.org/), [WormBase ParaSite](https://parasite.wormbase.org/), [VectorBase](https://www.vectorbase.org/), [RefSeq](https://www.ncbi.nlm.nih.gov/RefSeq/), [CCDS](https://www.ncbi.nlm.nih.gov/projects/CCDS/CcdsBrowse.cgi), etc. (1)).
