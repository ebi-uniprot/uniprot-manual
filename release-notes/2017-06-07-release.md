...
As of this release, [hapless-2 UniProtKB/Swiss-Prot entries](http://www.uniprot.org/uniprotkb?query=name:%22hapless-2%22+and+reviewed:true) have been created and are publicly available.
...
Example: [Q9ZNI1](http://www.uniprot.org/uniprotkb/Q9ZNI1.txt)
...
Example: [Q9ZNI1](http://www.uniprot.org/uniprotkb/Q9ZNI1.xml)
...
Example: [Q9ZNI1](http://www.uniprot.org/uniprotkb/Q9ZNI1.ttl)
...
Since release 2015_04, we are applying at each release a procedure to [identify highly redundant proteomes](http://www.uniprot.org/help/proteome_redundancy) within selected species groups using a combination of manual and automatic methods. This procedure prevents the creation of UniProtKB/TrEMBL entries from these redundant proteomes, but also means that a huge number of previously existing entries had to be [deleted from UniProtKB](http://www.uniprot.org/release-notes/2015-04-01-release) when the procedure was put in place.
...
To help users to link deleted to subsequently reinstated entries, we are introducing a file that maps old to new accession numbers via their [protein_ids](http://www.uniprot.org/faq/sequence_origin). This file is available (in compressed format) by FTP at
