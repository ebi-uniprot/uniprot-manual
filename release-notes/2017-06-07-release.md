...
To help users to link deleted to subsequently reinstated entries, we are introducing a file that maps old to new accession numbers via their [protein\_ids](http://www.uniprot.org/faq/sequence_origin). This file is available (in compressed format) by FTP at

[ftp://ftp.uniprot.org/pub/databases/uniprot/current\_release/knowledgebase/complete/docs/reinstated\_map.txt.gz](ftp://ftp.uniprot.org/pub/databases/uniprot/current_release/knowledgebase/complete/docs/reinstated_map.txt.gz)
