...
This exciting piece of information has been transferred to [UniProtKB/Swiss-Prot rat and _Drosophila_ ARC entries](http://www.uniprot.org/uniprotkb?query=accession:Q63053+OR+accession:Q7K1U0) by means of the classical pathway of expert curation and, as of this release, the updated records are publicly available.
...
[Show all entries having a cross-reference to ComplexPortal.](http://www.uniprot.org/uniprotkb?query=database:complexportal&sort=score)

Cross-references to ComplexPortal may be isoform-specific. The general format of isoform-specific cross-references was described in release [2014_03](http://www.uniprot.org/release-notes/2014-03-19-release) .
...
Example: [P41182](http://www.uniprot.org/uniprotkb/P41182)

[Show all entries having a cross-reference to ProteomicsDB.](http://www.uniprot.org/uniprotkb?query=database:proteomicsdb&sort=score)

Cross-references to ProteomicsDB may be isoform-specific. The general format of isoform-specific cross-references was described in release [2014_03](http://www.uniprot.org/release-notes/2014-03-19-release) .
...
Example: [Q13492](http://www.uniprot.org/uniprotkb/Q13492)

[Show all entries having a cross-reference to MoonDB.](http://www.uniprot.org/uniprotkb?query=database:moondb&sort=score)

### Text format

Example: [Q13492](http://www.uniprot.org/uniprotkb/Q13492.txt)

    DR   MoonDB; Q13492; Curated.

### XML format

Example: [Q13492](http://www.uniprot.org/uniprotkb/Q13492.xml)
...
Example: [Q13492](http://www.uniprot.org/uniprotkb/Q13492.ttl)
