...
[Show all entries having a cross-reference to ComplexPortal.](http://www.uniprot.org/uniprotkb?query=database:complexportal)
...
[Show all entries having a cross-reference to ProteomicsDB.](http://www.uniprot.org/uniprotkb?query=database:proteomicsdb)
...
[Show all entries having a cross-reference to MoonDB.](http://www.uniprot.org/uniprotkb?query=database:moondb)
