...
[Show all entries having a cross-reference to DrugCentral.](<http://www.uniprot.org/uniprotkb?query=database:(type:drugcentral)>)
...
[Show all entries having a cross-reference to Pharos.](<http://www.uniprot.org/uniprotkb?query=database:(type:pharos)>)
...
[Show all entries having a cross-reference to MassIVE.](<http://www.uniprot.org/uniprotkb?query=database:(type:massive)>)
