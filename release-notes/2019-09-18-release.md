...
As of this release nearly 70 magnetosome proteins have been annotated and can be retrieved using the term [magnetosome](http://www.uniprot.org/uniprotkb?query=magnetosome+AND+reviewed:yes) .
...
Example: [P35372](http://www.uniprot.org/uniprotkb/P35372.txt)

    DR   DrugCentral; P35372; -.

### XML format

Example: [P35372](http://www.uniprot.org/uniprotkb/P35372.xml)

    <dbReference type="DrugCentral" id="P35372"/>

### RDF format

Example: [P35372](http://www.uniprot.org/uniprotkb/P35372.ttl)
...
Example: [Q7Z3E2](http://www.uniprot.org/uniprotkb/Q7Z3E2.txt)

    DR   Pharos; Q7Z3E2; -.

### XML format

Example: [Q7Z3E2](http://www.uniprot.org/uniprotkb/Q7Z3E2.xml)
