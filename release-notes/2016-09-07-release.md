...
[Show all entries having a cross-reference to CDD.](http://www.uniprot.org/uniprotkb?query=database:cdd)
...
[Show all entries having a cross-reference to VectorBase.](http://www.uniprot.org/uniprotkb?query=database:vectorbase)
