...
All the [known pupylation-related proteins](http://www.uniprot.org/uniprotkb?query=keyword:KW-0833+AND+reviewed:true+AND+taxonomy_id:2) in bacteria have now been annotated in UniProtKB/Swiss-Prot.
