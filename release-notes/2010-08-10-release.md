...
UBC encode distinct poly-ubiquitin chains. In UniProtKB release 2010_08, the human ubiquitin protein sequence was represented by one single UniProtKB entry (UBIQ_HUMAN,

P62988 ), that included the ubiquitin protein sequences derived from all four of the aforementioned genes. For UniProt release 2010_09, these four genes were de-merged into 4 distinct UniProtKB entries corresponding to each of the four ubiquitin genes. Following the de-merge, ubiquitin chains from
