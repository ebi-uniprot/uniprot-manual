...
To get all reviewed UniProtKB Japonica entries, click [here](http://www.uniprot.org/uniprotkb?query=taxonomy_id:39947+AND+reviewed:yes) .

To get all reviewed UniProtKB Indica entries, click [here](http://www.uniprot.org/uniprotkb?query=taxonomy_id:39946+AND+reviewed:yes) .

To get all reviewed UniProtKB rice entries, click [here](http://www.uniprot.org/uniprotkb?query=taxonomy_id:39946+OR+taxonomy_id:39947+OR+taxonomy_id:4530%29+AND+reviewed:yes) .
