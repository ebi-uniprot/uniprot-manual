...
[Show all entries having a cross-reference to CollecTF.](http://www.uniprot.org/uniprotkb?query=database:collectf)
...
[Show all entries having a cross-reference to GeneDB.](http://www.uniprot.org/uniprotkb?query=database:genedb)
...
[Show all entries having a cross-reference to iPTMnet.](http://www.uniprot.org/uniprotkb?query=database%3Aiptmnet)
