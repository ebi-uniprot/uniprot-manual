...
[Show all the entries having a cross-reference to ChEMBL](http://www.uniprot.org/uniprotkb?query=database%3AChEMBL) .
...
[Show all the entries having a cross-reference to PaxDb](http://www.uniprot.org/uniprotkb?query=database%3APaxDb) .
