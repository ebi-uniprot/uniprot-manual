...
As of this release, [proteins involved in this new regulatory pathway](http://www.uniprot.org/uniprotkb?query=32322062) have been updated and are available in UniProtKB/Swiss-Prot.
...
Example: [P31751](http://www.uniprot.org/uniprotkb/P31751)

[Show all entries having a cross-reference to CPTC.](http://www.uniprot.org/uniprotkb?query=database:cptc&sort=score)

### Text format

Example: [P31751](http://www.uniprot.org/uniprotkb/P31751.txt)

    DR   CPTC; P31751; 6 antibodies.

### XML format

Example: [P31751](http://www.uniprot.org/uniprotkb/P31751.xml)
...
Example: [P31751](http://www.uniprot.org/uniprotkb/P31751.ttl)
...
Example: [A1D240](http://www.uniprot.org/uniprotkb/A1D240)

[Show all entries having a cross-reference to BMRB.](http://www.uniprot.org/uniprotkb?query=database:bmrb&sort=score)

### Text format

Example: [A1D240](http://www.uniprot.org/uniprotkb/A1D240.txt)

    DR   BMRB; A1D240; -.

### XML format

Example: [A1D240](http://www.uniprot.org/uniprotkb/A1D240.xml)

    <dbReference type="BMRB" id="A1D240"/>

### RDF format

Example: [A1D240](http://www.uniprot.org/uniprotkb/A1D240.ttl)
...
Example: [Q70Q12](http://www.uniprot.org/uniprotkb/Q70Q12)

[Show all entries having a cross-reference to PCDDB.](http://www.uniprot.org/uniprotkb?query=database:pcddb&sort=score)

### Text format

Example: [Q70Q12](http://www.uniprot.org/uniprotkb/Q70Q12.txt)

    DR   PCDDB; Q70Q12; -.

### XML format

Example: [Q70Q12](http://www.uniprot.org/uniprotkb/Q70Q12.xml)

    <dbReference type="PCDDB" id="Q70Q12"/>

### RDF format

Example: [Q70Q12](http://www.uniprot.org/uniprotkb/Q70Q12.ttl)
...
Example: [Q15326](http://www.uniprot.org/uniprotkb/Q15326)

[Show all entries having a cross-reference to SASBDB.](http://www.uniprot.org/uniprotkb?query=database:sasbdb&sort=score)

### Text format

Example: [Q15326](http://www.uniprot.org/uniprotkb/Q15326.txt)

    DR   SASBDB; Q15326; -.

### XML format

Example: [Q15326](http://www.uniprot.org/uniprotkb/Q15326.xml)

    <dbReference type="SASBDB" id="Q15326"/>

### RDF format

Example: [Q15326](http://www.uniprot.org/uniprotkb/Q15326.ttl)
