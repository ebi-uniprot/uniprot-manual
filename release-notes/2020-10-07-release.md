...
[Show all entries having a cross-reference to CPTC.](http://www.uniprot.org/uniprotkb?query=database:cptc)
...
[Show all entries having a cross-reference to BMRB.](http://www.uniprot.org/uniprotkb?query=database:bmrb)
...
[Show all entries having a cross-reference to PCDDB.](http://www.uniprot.org/uniprotkb?query=database:pcddb)
...
[Show all entries having a cross-reference to SASBDB.](http://www.uniprot.org/uniprotkb?query=database:sasbdb)
