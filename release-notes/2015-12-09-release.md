...
[Two recent papers](http://www.ncbi.nlm.nih.gov/pubmed/26416734,26416733) in Nature have shown that nef actually prevents the incorporation of host [SERINC3](http://www.uniprot.org/uniprotkb/Q13530) and [SERINC5](http://www.uniprot.org/uniprotkb/Q86VE9) proteins into the HIV-1 virion. These proteins dramatically decrease virion infectivity when they are part of its membrane. This study improves the understanding of nef function in virion infectivity. The means used by nef to achieve this function are still unknown, but are related to its capacity to prevent specific host proteins from reaching the plasma membrane. Human SERINC3 and SERINC5 functions are still not well understood, but further study on these proteins will reveal their antiviral action.

As of this release, [HIV-1 nef](http://www.uniprot.org/uniprotkb/P03406) and human proteins [SERINC3](http://www.uniprot.org/uniprotkb/Q13530) and [SERINC5](http://www.uniprot.org/uniprotkb/Q86VE9) have been updated and are publicly available.
...
Cross-references to SwissLipids may be isoform-specific (e.g. [Q08477](http://www.uniprot.org/uniprotkb/Q08477#function) ). The general format of isoform-specific cross-references was described in release [2014_03](http://www.uniprot.org/release-notes/2014-03-19-release) .

Example: [P52824](http://www.uniprot.org/uniprotkb/P52824#function)

[Show all entries having a cross-reference to SwissLipids.](http://www.uniprot.org/uniprotkb?query=database:swisslipids&sort=score)

### Text format

Example: [P52824](http://www.uniprot.org/uniprotkb/P52824.txt)

    DR   SwissLipids; SLP:000000740; -.

### XML format

Example: [P52824](http://www.uniprot.org/uniprotkb/P52824.xml)

    <dbReference type="SwissLipids" id="SLP:000000740"/>

### RDF format

Example: [P52824](http://www.uniprot.org/uniprotkb/P52824.ttl)
...
Example: [P26439](http://www.uniprot.org/uniprotkb/P26439#pathology_and_biotech)

[Show all entries having a cross-reference to MalaCards.](http://www.uniprot.org/uniprotkb?query=database:malacards&sort=score)

### Text format

Example: [P26439](http://www.uniprot.org/uniprotkb/P26439.txt)

    DR   MalaCards; HSD3B2; -.

### XML format

Example: [P26439](http://www.uniprot.org/uniprotkb/P26439.xml)

    <dbReference type="MalaCards" id="HSD3B2"/>

### RDF format

Example: [P26439](http://www.uniprot.org/uniprotkb/P26439.ttl)
...
- [UniProt programmatic access help pages](http://www.uniprot.org/help/programmatic_access)
...
Documentation on programmatic access to UniProt data can be found on the [UniProt website](http://www.uniprot.org/faq/programmatic_access) .
