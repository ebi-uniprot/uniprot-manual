...
[Show all entries having a cross-reference to SwissLipids.](http://www.uniprot.org/uniprotkb?query=database:swisslipids)
...
[Show all entries having a cross-reference to MalaCards.](http://www.uniprot.org/uniprotkb?query=database:malacards)
