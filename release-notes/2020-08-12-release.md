...
As of this release, [ZBP1](http://www.uniprot.org/uniprotkb?query=accession:Q9H171+OR+accession:Q9QY24+OR+accession:Q8VDA5), [RIPK3](http://www.uniprot.org/uniprotkb?query=accession:Q9Y572+OR+accession:Q9QZL0+OR+accession:Q9Z2P5), and [MLKL](http://www.uniprot.org/uniprotkb?query=accession:Q8NB16+OR+accession:Q9D2Y4) have been updated and are available in UniProtKB/Swiss-Prot.
...
[Show all entries having a cross-reference to GlyGen.](http://www.uniprot.org/uniprotkb?query=database:glygen&sort=score)

### Text format

Example: [P14210](http://www.uniprot.org/uniprotkb/P14210.txt)

    DR   GlyGen; P14210; 5 sites, 8 N-linked glycans (4 sites), 1 O-linked glycan (1 site).

### XML format

Example: [P14210](http://www.uniprot.org/uniprotkb/P14210.xml)
...
Example: [P14210](http://www.uniprot.org/uniprotkb/P14210.ttl)
...
Example: [P01042](http://www.uniprot.org/uniprotkb/P01042)

[Show all entries having a cross-reference to PathwayCommons.](http://www.uniprot.org/uniprotkb?query=database:pathwaycommons&sort=score)

### Text format

Example: [P01042](http://www.uniprot.org/uniprotkb/P01042.txt)

    DR   PathwayCommons; P01042; -.

### XML format

Example: [P01042](http://www.uniprot.org/uniprotkb/P01042.xml)

    <dbReference type="PathwayCommons" id="P01042"/>

### RDF format

Example: [P01042](http://www.uniprot.org/uniprotkb/P01042.ttl)
...
Example: [P12763](http://www.uniprot.org/uniprotkb/P12763.txt)
...
Example: [P12763](http://www.uniprot.org/uniprotkb/P12763.xml)
...
Example: [P12763](http://www.uniprot.org/uniprotkb/P12763.ttl)
