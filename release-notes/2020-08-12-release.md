...
[Show all entries having a cross-reference to GlyGen.](http://www.uniprot.org/uniprotkb?query=database:glygen)
...
[Show all entries having a cross-reference to PathwayCommons.](http://www.uniprot.org/uniprotkb?query=database:pathwaycommons)
