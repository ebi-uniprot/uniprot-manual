...
[Show all entries having a cross-reference to DEPOD.](http://www.uniprot.org/uniprotkb?query=database%3Adepod)
...
[Show all entries having a cross-reference to MoonProt.](http://www.uniprot.org/uniprotkb?query=database%3Amoonprot)
