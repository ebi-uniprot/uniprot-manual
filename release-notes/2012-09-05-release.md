...
[Show all the entries having a cross-reference to GenomeRNAi](http://www.uniprot.org/uniprotkb?query=database%3AGenomeRNAi&sort=score)
...
[Show all the entries having a cross-reference to UniPathway](http://www.uniprot.org/uniprotkb?query=database%3AUniPathway&sort=score)
