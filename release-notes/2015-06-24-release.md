...
_Arabidopsis thaliana_ [miPEP165a](http://www.uniprot.org/uniprotkb/P0DKI9), [miPEP160b](http://www.uniprot.org/uniprotkb/P0DKJ0), [miPEP164a](http://www.uniprot.org/uniprotkb/P0DKJ1) and [miPEP319a](http://www.uniprot.org/uniprotkb/P0DKJ2) and _Medicago truncatula_ [miPEP171b](http://www.uniprot.org/uniprotkb/P0DKI8) peptides have been manually annotated and are integrated into UniProtKB/Swiss-Prot as of this release. The sequences of the other 2 _Medicago truncatula_ functionally characterized peptides, miPEP169d and miPEP171e, are unfortunately not available.
...
Example: [P0C064](http://www.uniprot.org/uniprotkb/P0C064#function)

[Show all entries having a cross-reference to ESTHER.](http://www.uniprot.org/uniprotkb?query=database%3Aesther&sort=score)

### Text format

Example: [P0C064](http://www.uniprot.org/uniprotkb/P0C064.txt)

    DR   ESTHER; bacbr-grsb; Thioesterase.

### XML format

Example: [P0C064](http://www.uniprot.org/uniprotkb/P0C064.xml)
...
Example: [P31946](http://www.uniprot.org/uniprotkb/P31946#expression)

[Show all entries having a cross-reference to Genevisible.](http://www.uniprot.org/uniprotkb?query=database%3Agenevisible&sort=score)

### Text format

Example: [P31946](http://www.uniprot.org/uniprotkb/P31946.txt)

    DR   Genevisible; P31946; HS.

### XML format

Example: [P31946](http://www.uniprot.org/uniprotkb/P31946.xml)
...
Example: [Q9P3A7](http://www.uniprot.org/uniprotkb/Q9P3A7.txt)

    DR   PomBase; SPAC1565.08; cdc48.

Example: [O60058](http://www.uniprot.org/uniprotkb/O60058.txt)

    DR   PomBase; SPBC56F2.07c; -.

### XML format

Example: [Q9P3A7](http://www.uniprot.org/uniprotkb/Q9P3A7.xml)

    <dbReference type="PomBase" id="SPAC1565.08">
      <property type="gene designation" value="cdc48"/>
    </dbReference>

Example: [O60058](http://www.uniprot.org/uniprotkb/O60058.xml)
