...
[Show all entries having a cross-reference to TreeFam.](http://www.uniprot.org/uniprotkb?query=database%3Atreefam)
...
[Show all entries having a cross-reference to BioGrid.](http://www.uniprot.org/uniprotkb?query=database%3Abiogrid)
