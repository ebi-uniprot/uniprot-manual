...
While awaiting further exciting discoveries in the field of epigenetics, we have already updated [MTRR entries](http://www.uniprot.org/uniprotkb?query=gene:dnmt2+and+reviewed:yes) with the current knowledge and made them available.
