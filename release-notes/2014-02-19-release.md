...
While awaiting further exciting discoveries in the field of epigenetics, we have already updated [MTRR entries](http://www.uniprot.org/uniprotkb?query=gene:dnmt2+and+reviewed:true) with the current knowledge and made them available.
...
[A1RHR2](http://www.uniprot.org/uniprotkb/A1RHR2.txt) :
...
[O02781](http://www.uniprot.org/uniprotkb/O02781.txt) :
...
[Q9K3D6](http://www.uniprot.org/uniprotkb/Q9K3D6.txt) :
...
[A1RHR2](http://www.uniprot.org/uniprotkb/A1RHR2.xml) :
...
[O02781](http://www.uniprot.org/uniprotkb/O02781.xml) :
...
[Q9K3D6](http://www.uniprot.org/uniprotkb/Q9K3D6.xml) :
...
Example: [Q8CFE6](http://www.uniprot.org/uniprotkb/Q8CFE6#section_x-ref)

[Show all entries having a cross-reference to TreeFam.](http://www.uniprot.org/uniprotkb?query=database%3Atreefam&sort=score)

### Text format

Example: [Q8CFE6](http://www.uniprot.org/uniprotkb/Q8CFE6.txt)

    DR   TreeFam; TF328787; -.

### XML format

Example: [Q8CFE6](http://www.uniprot.org/uniprotkb/Q8CFE6.xml)
...
Example: [O46201](http://www.uniprot.org/uniprotkb/O46201#section_x-ref)

[Show all entries having a cross-reference to BioGrid.](http://www.uniprot.org/uniprotkb?query=database%3Abiogrid&sort=score)

### Text format

Example: [O46201](http://www.uniprot.org/uniprotkb/O46201.txt)

    DR   BioGrid; 69392; 1.

### XML format

Example: [O46201](http://www.uniprot.org/uniprotkb/O46201.xml)
