...
[annotation:(type:"catalytic activity" chebi:"(3R)-3-hydroxy-L-arginine residue \[78294\]")](http://www.uniprot.org/uniprotkb?query=annotation%3A%28type%3A%22catalytic+activity%22+chebi%3A%22%283R%29-3-hydroxy-L-arginine+residue+%5B78294%5D%22%29&sort=score)
...
Example: [E9PDY4](http://www.uniprot.org/uniprotkb/E9PDY4)

[Show all entries having a cross-reference to NIAGADS.](http://www.uniprot.org/uniprotkb?query=database:niagads&sort=score)

### Text format

Example: [E9PDY4](http://www.uniprot.org/uniprotkb/E9PDY4.txt)

    DR   NIAGADS; ENSG00000203710; -.

### XML format

Example: [E9PDY4](http://www.uniprot.org/uniprotkb/E9PDY4.xml)

    <dbReference type="NIAGADS" id="ENSG00000203710"/>

### RDF format

Example: [E9PDY4](http://www.uniprot.org/uniprotkb/E9PDY4.ttl)
...
Example: [P04083](http://www.uniprot.org/uniprotkb/P04083)

[Show all entries having a cross-reference to CPTAC.](http://www.uniprot.org/uniprotkb?query=database:cptac&sort=score)

### Text format

Example: [P04083](http://www.uniprot.org/uniprotkb/P04083.txt)

    DR  CPTAC; CPTAC-311; -.

### XML format

Example: [P04083](http://www.uniprot.org/uniprotkb/P04083.xml)

    <dbReference type="CPTAC" id="CPTAC-311"/>

### RDF format

Example: [P04083](http://www.uniprot.org/uniprotkb/P04083.ttl)
