...
The apoplast, the extracellular space between plant cells, is a battleground between plants and attacking microorganisms. The battle often starts with the secretion of carbohydrate-degrading enzymes by the invader and a counter-attack by the plant with dedicated enzyme inhibitors. This happens for instance when [_Phytophthora sojae_](https://www.uniprot.org/taxonomy/1094619) invades soybean. During very early infection stages (20 minutes to 2 hours), the oomycete expresses and secretes high levels of a xyloglucanase enzyme, called [XEG1](http://www.uniprot.org/uniprotkb/G4ZHR2). XEG1 degrades the plant cell wall polymers and not only permits pathogen invasion, but also provides it with nutrients. XEG1 expression declines rapidly from 3 hours onwards.
