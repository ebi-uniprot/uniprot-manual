...
We have made the following changes to the [UniProtKB XSD](https://www.uniprot.org/docs/uniprot.xsd) to standardize the description of a ligand, and optionally the bound part of the ligand, with the ChEBI ontology.
