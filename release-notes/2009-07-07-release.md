...
As of this release, all _D. discoideum_ [PKSs](http://www.uniprot.org/uniprotkb?query=taxonomy_id:44689+AND+reviewed:true+AND+keyword:KW-0181+AND+name:polyketide+synthase) can be retrieved from UniProtKB/Swiss-Prot.
