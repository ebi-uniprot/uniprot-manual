...
The social amoeba [*Dictyostelium discoideum*](http://en.wikipedia.org/wiki/Dictyostelium_discoideum) lives in the soil and feeds on a variety of bacteria and fungi. In its natural habitat, *D. discoideum* has several rivals, such as bacteria, nematodes, and *Dictyostelium caveatum*. However, this slime mold is not defenseless and it has been shown, for instance, to be able to [repel nematodes](http://www.ncbi.nlm.nih.gov/pubmed/8643493) "by secreting compounds". It appears today that *D. discoideum* has at least 40 functional PKS genes and 5 probable pseudogenes. This is the [largest number of PKSs](http://www.ncbi.nlm.nih.gov/pubmed/17660200,18252726) of all known genomes.
...
As of this release, all *D. discoideum* [PKSs](http://www.uniprot.org/uniprot/?query=taxonomy:44689+AND+reviewed:yes+AND+keyword:181+AND+name:polyketide+synthase) can be retrieved from UniProtKB/Swiss-Prot.
