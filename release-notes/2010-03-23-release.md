...
[Show all the entries having a cross-reference to GenoList](http://www.uniprot.org/uniprotkb?query=database:GenoList) .
...
[Show all the entries having a cross-reference to ConoServer.](http://www.uniprot.org/uniprotkb?query=database:ConoServer)
