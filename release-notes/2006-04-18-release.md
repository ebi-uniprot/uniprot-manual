...
In order to acquire genetic competence once the cell density has reached a critical threshold, bacteria have developed a sophisticated quorum-sensing system. This system proceeds through the release of a pheromone, [comX](https://www.uniprot.org/uniprotkb/Q8VL79), that activates a two-component system, which eventually propagates the signal into the cell. Both components of this system have been identified: they are the sensor histidine kinase, [comP](http://www.uniprot.org/uniprotkb/Q99027), and the response regulator, the transcription factor [comA](http://www.uniprot.org/uniprotkb/P14204) .
