...
As of this release, [murine DNASE1 and DNASE1L3 and their orthologs](<http://www.uniprot.org/uniprotkb?query=(gene:dnase1l3+OR+gene:dnase1)+AND+reviewed:yes+AND+taxonomy:mammalia>) in other mammalian species have been updated and are now publicly available.
