...
UniProtKB/Swiss-Prot is happy to announce the annotation of [over 4,000 entries](http://www.uniprot.org/uniprotkb?query=organism_id:9913+reviewed:true) of a very popular animal in Switzerland, almost a national symbol: [Bos taurus](http://www.uniprot.org/taxonomy/9913), in other words, the cow.
