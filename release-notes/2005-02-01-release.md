...
|                   |                                                                                                                                                                                                                                           |
| :---------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| SP_Ac             | is the Swiss-Prot or TrEMBL accession number of the interacting protein. If appropriate, the [IsoId](http://www.uniprot.org/manual/alternative_products) is used instead to specify the relevant interacting protein isoform.             |
...
Example entry with many interaction lines: [Q02821](http://www.uniprot.org/uniprotkb/Q02821#section_comments) .
