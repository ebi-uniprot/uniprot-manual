...
[Show all entries having a cross-reference to DisGeNET.](http://www.uniprot.org/uniprotkb?query=database:disgenet)
...
[Show all entries having a cross-reference to OpenTargets.](http://www.uniprot.org/uniprotkb?query=database:opentargets)
