...
UniProtKB/Swiss-Prot current release contains 1,803 fully [annotated _Dictyostelium discoideum_ entries](http://www.uniprot.org/uniprotkb?query=taxonomy:44689+AND+reviewed:yes), which represents about 15% of the complete proteome. A [complete non-redundant set of _Dictyostelium discoideum_ proteins](http://www.uniprot.org/uniprotkb?query=taxonomy:44689+AND+keyword:181) can be retrieved from UniProtKB with the keyword 'Complete proteome'.
