...
[Show all entries having a cross-reference to IDEAL.](http://www.uniprot.org/uniprotkb?query=database:ideal)
...
[Show all entries having a cross-reference to BioGRID-ORCS.](http://www.uniprot.org/uniprotkb?query=database:biogrid-orcs)
