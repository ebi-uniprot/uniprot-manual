...
[Show all entries having a cross-reference to CCDS.](http://www.uniprot.org/uniprotkb?query=database%3Accds)
...
[Show all entries having a cross-reference to GeneReviews.](http://www.uniprot.org/uniprotkb?query=database%3Agenereviews)
