...
As of this release, the [human PER3 entry](http://www.uniprot.org/uniprotkb/P56645) has been updated in UniProtKB/Swiss-Prot.
...
Cross-references to CCDS may be isoform-specific. The general format of isoform-specific cross-references was described in release [2014_03](http://www.uniprot.org/release-notes/2014-03-19-release) .

Example: [O70554](http://www.uniprot.org/uniprotkb/O70554#section_x-ref)

[Show all entries having a cross-reference to CCDS.](http://www.uniprot.org/uniprotkb?query=database%3Accds&sort=score)

### Text format

Examples:

[O70554](http://www.uniprot.org/uniprotkb/O70554.txt)

    DR   CCDS; CCDS38509.1; -.

[P00750](http://www.uniprot.org/uniprotkb/P00750.txt)
...
[O70554](http://www.uniprot.org/uniprotkb/O70554.xml)

    <dbReference type="CCDS" id="CCDS38509.1"/>

[P00750](http://www.uniprot.org/uniprotkb/P00750.xml)
...
Example: [O00555](http://www.uniprot.org/uniprotkb/O00555#section_x-ref)

[Show all entries having a cross-reference to GeneReviews.](http://www.uniprot.org/uniprotkb?query=database%3Agenereviews&sort=score)

### Text format

Example: [O00555](http://www.uniprot.org/uniprotkb/O00555.txt)

    DR   GeneReviews; CACNA1A; -.

### XML format

Example: [O00555](http://www.uniprot.org/uniprotkb/O00555.xml)
