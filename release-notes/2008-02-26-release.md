...
UniProtKB/Swiss-Prot entries describing a [selenocysteine](http://www.uniprot.org/uniprotkb?query=keyword:KW-0712+AND+reviewed:true) - and [pyrrolysine](http://www.uniprot.org/uniprotkb?query=keyword:KW-0669+AND+reviewed:true) - containing sequences can be retrieved with the 'Selenocysteine' and 'Pyrrolysine' keywords, respectively.
