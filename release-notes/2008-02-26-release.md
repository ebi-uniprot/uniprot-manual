...
UniProtKB/Swiss-Prot entries describing a [selenocysteine](http://www.uniprot.org/uniprotkb?query=keyword:712+AND+reviewed:yes) - and [pyrrolysine](http://www.uniprot.org/uniprotkb?query=keyword:669+AND+reviewed:yes) - containing sequences can be retrieved with the 'Selenocysteine' and 'Pyrrolysine' keywords, respectively.
