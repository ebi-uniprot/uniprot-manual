...
- We have added 11 new documents:
  ...
  - [Brucella abortus strain 2308: entries and gene names](https://www.uniprot.org/docs/brua2)
  - [bruab.txtBrucella abortus: entries and gene names](https://www.uniprot.org/docs/bruab)
  - [Brucella melitensis: entries and gene names](https://www.uniprot.org/docs/brume)
  - [Brucella suis: entries and gene names](https://www.uniprot.org/docs/brusu)
  - [Coxiella burnetii: entries and gene names](https://www.uniprot.org/docs/coxbu)
  - [Rickettsia bellii strain RML369-C: entries and gene names](https://www.uniprot.org/docs/ricbr)
  - [Rickettsia conorii: entries and gene names](https://www.uniprot.org/docs/riccn)
  - [Rickettsia felis (Rickettsia azadi): entries and gene names](https://www.uniprot.org/docs/ricfe)
  - [Rickettsia typhi: entries and gene names](https://www.uniprot.org/docs/ricty)
...
UniProtKB/Swiss-Prot entries describing a [selenocysteine](https://www.uniprot.org/uniprotkb?query=keyword:KW-0712+AND+reviewed:true) - and [pyrrolysine](http://www.uniprot.org/uniprotkb?query=keyword:KW-0669+AND+reviewed:true) - containing sequences can be retrieved with the 'Selenocysteine' and 'Pyrrolysine' keywords, respectively.
