...
Programmatic access to our "Retrieve/IDmapping" service should be addressed to the URL path `/uploadlists` as shown in the code examples in the respective service help pages [ID mapping](https://www.uniprot.org/help/id_mapping) and [Batch retrieval](https://www.uniprot.org/help/api_batch_retrieval) .
