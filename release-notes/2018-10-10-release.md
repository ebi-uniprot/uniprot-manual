...
Programmatic access to our "Retrieve/IDmapping" service should be addressed to the URL path `/uploadlists` as shown in the code examples in the respective service help pages [ID mapping](https://www.uniprot.org/help/api_idmapping) and [Batch retrieval](http://www.uniprot.org/help/api_batch_retrieval) .
