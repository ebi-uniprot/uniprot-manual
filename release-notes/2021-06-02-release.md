...
As of this release, we have introduced predictions of long, intrinsically disordered regions into the UniProtKB annotation pipeline, using the [MobiDB-lite](https://doi.org/10.1093/bioinformatics/btx015) method. [YTHDF entries](<http://www.uniprot.org/uniprotkb?query=(gene:ythdf1+OR+gene:ythdf2+OR+gene:ythdf3)+AND+reviewed:true>) have been updated and are now publicly available.
