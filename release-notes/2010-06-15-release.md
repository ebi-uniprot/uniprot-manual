...
INSDC and UniProt also created a more [generalised protein guideline](https://www.uniprot.org/docs/gennameprot) (see file [gennameprot.txt](http://www.uniprot.org/docs/gennameprot) ) to make this useful for taxa outside cellular prokaryotes. The decision by the
