...
Using our big brains, we have annotated all [3 NOTCH2NL gene products](http://www.uniprot.org/uniprotkb?query=accession:q7z3s9+OR+accession:p0dpk3+OR+accession:p0dpk4) in UniProtKB/Swiss-Prot and they are publicly available as of this release.
...
Example: [P02730](http://www.uniprot.org/uniprotkb/P02730.txt)
...
Example: [P02730](http://www.uniprot.org/uniprotkb/P02730.xml)
...
Example: [P02730](http://www.uniprot.org/uniprotkb/P02730.ttl)
...
Example: [P10361](http://www.uniprot.org/uniprotkb/P10361.txt)

    DR   Bgee; ENSRNOG00000010756; Expressed in 10 organ(s), highest expression level in spleen.

### XML format

Example: [P10361](http://www.uniprot.org/uniprotkb/P10361.xml)
...
Example: [P10361](http://www.uniprot.org/uniprotkb/P10361.ttl)
