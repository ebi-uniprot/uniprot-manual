...
[Aflatoxins](http://en.wikipedia.org/wiki/Aflatoxin) are very important members of the family of [mycotoxins](http://en.wikipedia.org/wiki/Mycotoxin), that contaminate food and feed crops. More than 14 different aflatoxins have been identified so far. These secondary metabolites are mainly produced by the filamentous fungi [_Aspergillus flavus_](https://www.uniprot.org/taxonomy/332952) and [_Aspergillus parasiticus_](http://www.uniprot.org/taxonomy/5067). These organisms grow in warm and humid locations, such as those where crops (e.g. rice, maize and ground nuts) are stored.
