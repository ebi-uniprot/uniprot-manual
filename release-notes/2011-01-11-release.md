...
[All manually annotated _A.thaliana_ entries](http://www.uniprot.org/uniprotkb?query=organism_id:3702+AND+reviewed:true) can be retrieved from UniProtKB/Swiss-Prot using the organism name " _Arabidopsis thaliana_ " (or the taxonomy identifier 3702), with the restriction: “reviewed:true”.
