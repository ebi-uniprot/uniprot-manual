...
Zebrafish and bullfrog CYP27C1 entries have been annotated in UniProtKB/Swiss-Prot. The preliminary sequence of American bullfrog CYP27C1 was kindly provided by Professor Corbo and Dr. Enright and we would like to thank them sincerely. The human ortholog has been updated. All [3 entries](http://www.uniprot.org/uniprotkb?query=gene:cyp27c1+AND+%28organism:7955+OR+organism_id:8400+OR+organism_id:9606%29+AND+reviewed:true) are publicly available as of this release.
...
Example: [Q43125](http://www.uniprot.org/uniprotkb/Q43125#cross_references)

[Show all entries having a cross-reference to Araport.](http://www.uniprot.org/uniprotkb?query=database:araport&sort=score)

### Text format

Example: [Q43125](http://www.uniprot.org/uniprotkb/Q43125.txt)

    DR   Araport; AT4G08920; -.

### XML format

Example: [Q43125](http://www.uniprot.org/uniprotkb/Q43125.xml)

    <dbReference type="Araport" id="AT4G08920"/>

### RDF format

Example: [Q43125](http://www.uniprot.org/uniprotkb/Q43125.ttl)
...
Example: [P01871](http://www.uniprot.org/uniprotkb/P01871#function)

[Show all entries having a cross-reference to IMGT/GENE-DB.](http://www.uniprot.org/uniprotkb?query=database:imgt_gene-db&sort=score)

### Text format

Example: [P01871](http://www.uniprot.org/uniprotkb/P01871.txt)

    DR   IMGT_GENE-DB; IGHM; -.

### XML format

Example: [P01871](http://www.uniprot.org/uniprotkb/P01871.xml)

    <dbReference type="IMGT_GENE-DB" id="IGHM"/>

### RDF format

Example: [P01871](http://www.uniprot.org/uniprotkb/P01871.ttl)
...
Example: [Q9ZVI3](http://www.uniprot.org/uniprotkb/Q9ZVI3.txt)
...
Example: [Q9ZVI3](http://www.uniprot.org/uniprotkb/Q9ZVI3.xml)
...
Example: [Q9ZVI3](http://www.uniprot.org/uniprotkb/Q9ZVI3.ttl)
...
[Sequence similarity](http://www.uniprot.org/help/sequence_similarities) annotations were mainly used to describe two types of information:
