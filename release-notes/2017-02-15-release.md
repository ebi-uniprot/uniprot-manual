...
[Show all entries having a cross-reference to Araport.](http://www.uniprot.org/uniprotkb?query=database:araport)
...
[Show all entries having a cross-reference to IMGT/GENE-DB.](http://www.uniprot.org/uniprotkb?query=database:imgt_gene-db)
