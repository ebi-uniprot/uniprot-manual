...
In the current version of UniProtKB/Swiss-Prot, close to [82'000 entries](<http://www.uniprot.org/uniprotkb?query=annotation:(type:pathway)+AND+reviewed:yes>) are annotated with the UniPathway controlled vocabulary. The UniProt web site supplies direct links to the [UniPathway](http://www.grenoble.prabi.fr/obiwarehouse/unipathway) web server that provides more detailed information on pathways, sub-pathways and biochemical reactions.
