...
<p>
 ...
 <a href="https://www.uniprot.org/uniprotkb/P16442">
  ABO
 </a>
...
<p>
 ...
 <a href="https://www.uniprot.org/uniprotkb/P0DTR4">
  ADAC
 </a>) deacylates all A antigen subtypes tested (and there are many), while the second enzyme (A type blood alpha-D-galactosamine galactosaminidase,
 <a href="https://www.uniprot.org/uniprotkb/P0DTR5">
  AGAL
...
<p>
 As of this release,
 <a href="https://www.uniprot.org/uniprotkb?query=id:P0DTR4+OR+id:P0DTR5">
  ADAC and AGAL
 </a>
...
<p>
 ...
 <a href="https://www.uniprot.org/release-notes/2019-12-18-release#text_ft">
  changes of the FT section
 </a>
 likely affects all parsers, and software will have to be adapted accordingly. The
 <a href="https://www.uniprot.org/release-notes/2019-12-18-release#text_cc">
...
<p>
 ...
 <a href="https://www.uniprot.org#text_format">
  Text format
 </a>
 .
</p>
...
<p>
 ...
 <a href="https://www.uniprot.org/release-notes/2010-11-30-release">
  255 characters
 </a>
 ...
 <a href="https://www.uniprot.org#text_ft">
...
<p>
 To reduce
 <a href="https://www.uniprot.org/help/redundancy">
  database redundancy
 </a>
, the UniProtKB/Swiss-Prot policy is to describe, whenever possible, all protein products that are encoded by one gene in a given species in a single entry. This includes
 ...
 <a href="https://www.uniprot.org/help/alternative_products#iso_name">
  name
 </a>
 and a
 ...
 <a href="https://www.uniprot.org/help/canonical_and_isoforms">
  canonical sequence
 </a>
 that is shown in the UniProtKB text and XML format (the RDF format shows all sequences). All
 <a href="https://www.uniprot.org/help/sequence_annotation">
...
<p>
 ...
 <code>
  &lt;ProductName&gt;
 </code>) and a unique ID (
 <code>
  &lt;ProductId&gt;
 </code>) for the product that they describe:
</p>
<ul>
 <li>
...
<p>
 Example:
 <a href="https://rest.uniprot.org/uniprotkb/O60443.txt">
  O60443
 </a>
</p>
<pre>CC   -!- ALTERNATIVE PRODUCTS:
...
. Different products are described in separate annotations (see
 <a href="https://www.uniprot.org#function">
  FUNCTION
 </a>
 and
 <a href="https://www.uniprot.org#bpc">
...
<p>
 ...
 <a href="https://www.uniprot.org/help/line_length_change">
  Change of line length in UniProtKB text format
 </a>):
</p>
...
<p>
 ...
 <a href="https://www.uniprot.org/help/interaction_change">
...
<p>
 Example:
 <a href="https://rest.uniprot.org/uniprotkb/Q96F85.txt">
  Q96F85
 </a>
</p>
<pre>CC   -!- ALTERNATIVE PRODUCTS:
...
<p>
 Example:
 <a href="https://rest.uniprot.org/uniprotkb/P35555.txt">
  P35555
 </a>
</p>
...
<p>
 <em>
  ...
  <a href="https://www.uniprot.org/release-notes/2007-10-23-release">
...
<p>
 Example:
 <a href="https://rest.uniprot.org/uniprotkb/Q13421.txt">
  Q13421
 </a>
</p>
<pre>CC   -!- ALTERNATIVE PRODUCTS:
...
<p>
 Example:
 <a href="https://rest.uniprot.org/uniprotkb/P09493.txt">
  P09493
 </a>
</p>
<pre>CC   -!- ALTERNATIVE PRODUCTS:
...
<p>
 Example:
 <a href="https://rest.uniprot.org/uniprotkb/Q9P225.txt">
  Q9P225
 </a>
</p>
<pre>CC   -!- ALTERNATIVE PRODUCTS:
...
<p>
 Example:
 <a href="https://rest.uniprot.org/uniprotkb/P50570.txt">
  P50570
 </a>
</p>
<pre>CC   -!- ALTERNATIVE PRODUCTS:
...
<p>
 Example:
 <a href="https://rest.uniprot.org/uniprotkb/Q2YHF0.txt">
  Q2YHF0
 </a>
</p>
...
<p>
 <em>
  Please note that the
  <a href="https://www.uniprot.org/release-notes/2014-11-26-release">
...
<p>
 Example:
 <a href="https://rest.uniprot.org/uniprotkb/P26662.txt">
  P26662
 </a>
</p>
...
<p>
 Example:
 <a href="https://rest.uniprot.org/uniprotkb/Q9ULC5.txt">
  Q9ULC5
 </a>
</p>
<pre>CC   -!- ALTERNATIVE PRODUCTS:
...
<p>
 Example:
 <a href="https://rest.uniprot.org/uniprotkb/Q9NQS3.txt">
  Q9NQS3
 </a>
</p>
<p>
...
<p>
 ...
 <a href="https://www.uniprot.org#line_length">
  Change of line length in UniProtKB text format
 </a>
 above).
</p>
<p>
 Example:
 <a href="https://rest.uniprot.org/uniprotkb/P84077.txt">
  P84077
 </a>
</p>
<p>
...
<p>
 Example:
 <a href="https://rest.uniprot.org/uniprotkb/P0C551.txt">
  P0C551
 </a>
</p>
<p>
...
<p>
 Example:
 <a href="https://rest.uniprot.org/uniprotkb/P12821.txt">
  P12821
 </a>
</p>
<p>
...
<ul>
 <li>
  ...
  <a href="https://www.uniprot.org/help/alternative_products#iso_id">
   isoform ID
  </a>) when the coordinates are not for the
  <a href="https://www.uniprot.org/help/canonical_and_isoforms">
   canonical sequence
  </a>
 . Sequence coordinates may currently be given for "rna editing", "sequence caution" and "mass spectrometry" annotations. In the future
  <a href="https://www.uniprot.org/help/sequence_caution_positions_change">
   sequence caution
  </a>
  and
  <a href="https://www.uniprot.org#mass_spectrometry">
   mass spectrometry
  </a>
...
<p>
 Example:
 <a href="https://rest.uniprot.org/uniprotkb/Q13421.xml">
  Q13421
 </a>
</p>
<pre>&lt;comment type="alternative products"&gt;
...
<p>
 Example:
 <a href="https://rest.uniprot.org/uniprotkb/P26662.xml">
  P26662
 </a>
</p>
...
<p>
 Example:
 <a href="https://rest.uniprot.org/uniprotkb/P84077.xml">
  P84077
 </a>
</p>
...
<p>
 Example:
 <a href="https://rest.uniprot.org/uniprotkb/P12821.xml">
  P12821
 </a>
</p>
<p>
...
<p>
 ...
 <a href="https://www.uniprot.org/help/canonical_and_isoforms">
  canonical sequence
 </a>). Annotations that do not refer to a specific location on a protein sequence, but that apply to a given product, describe the sequence of this product with a
...
<p>
 Example:
 <a href="https://rest.uniprot.org/uniprotkb/Q13421.ttl">
  Q13421
 </a>
</p>
...
<p>
 Example:
 <a href="https://www.uniprot.org/uniprotkb/Q9Y2I1">
  Q9Y2I1
 </a>
</p>
<p>
 <a href="https://www.uniprot.org/uniprotkb?query=database:(type:rnact)&amp;sort=score">
...
<p>
 Example:
 <a href="https://rest.uniprot.org/uniprotkb/Q9Y2I1.txt">
  Q9Y2I1
 </a>
</p>
...
<p>
 Example:
 <a href="https://rest.uniprot.org/uniprotkb/Q9Y2I1.xml">
  Q9Y2I1
 </a>
</p>
...
<p>
 Example:
 <a href="https://rest.uniprot.org/uniprotkb/Q9Y2I1.ttl">
  Q9Y2I1
 </a>
</p>
<pre>uniprot:Q9Y2I1
...
<p>
 Example:
 <a href="https://rest.uniprot.org/uniprotkb/P33151.txt">
  P33151
 </a>
</p>
...
<p>
 Example:
 <a href="https://rest.uniprot.org/uniprotkb/P33151.xml">
  P33151
 </a>
</p>
...
<p>
 Example:
 <a href="https://rest.uniprot.org/uniprotkb/P33151.ttl">
  P33151
 </a>
</p>
<pre>uniprot:P33151
...
<ul>
 <li>
  <a href="https://www.uniprot.org/diseases/DI-05648">
   Congenital disorder of glycosylation 1CC
  </a>
 </li>
 <li>
  <a href="https://www.uniprot.org/diseases/DI-05665">
   Epilepsy, idiopathic generalized 16
  </a>
 </li>
 <li>
  <a href="https://www.uniprot.org/diseases/DI-05652">
   Epileptic encephalopathy, early infantile, 78
  </a>
 </li>
 <li>
  <a href="https://www.uniprot.org/diseases/DI-05653">
   Epileptic encephalopathy, early infantile, 79
  </a>
 </li>
 <li>
  <a href="https://www.uniprot.org/diseases/DI-05661">
   Epileptic encephalopathy, early infantile, 80
  </a>
 </li>
 <li>
  <a href="https://www.uniprot.org/diseases/DI-05663">
   Glycosylphosphatidylinositol biosynthesis defect 21
  </a>
 </li>
 <li>
  <a href="https://www.uniprot.org/diseases/DI-05659">
   Hypothyroidism, congenital, non-goitrous, 7
  </a>
 </li>
 <li>
  <a href="https://www.uniprot.org/diseases/DI-05650">
   Hypothyroidism, congenital, non-goitrous, 8
  </a>
 </li>
 <li>
  <a href="https://www.uniprot.org/diseases/DI-05651">
   Hypothyroidism, congenital, non-goitrous, 9
  </a>
 </li>
 <li>
  <a href="https://www.uniprot.org/diseases/DI-05662">
 ...
 <li>
  <a href="https://www.uniprot.org/diseases/DI-05654">
   Mitochondrial DNA depletion syndrome 17
  </a>
 </li>
 <li>
  <a href="https://www.uniprot.org/diseases/DI-05660">
   Myopathy, congenital, progressive, with scoliosis
  </a>
 </li>
 <li>
  <a href="https://www.uniprot.org/diseases/DI-05664">
   Nephrotic syndrome 21
  </a>
 </li>
 <li>
  <a href="https://www.uniprot.org/diseases/DI-05655">
   Neurodevelopmental disorder with ataxia, hypotonia, and microcephaly
  </a>
 </li>
 <li>
  <a href="https://www.uniprot.org/diseases/DI-05656">
   Neurodevelopmental disorder with cataracts, poor growth, and dysmorphic facies
  </a>
 </li>
 <li>
  <a href="https://www.uniprot.org/diseases/DI-05657">
   Neurodevelopmental disorder with cerebellar hypoplasia and spasticity
  </a>
 </li>
 <li>
  <a href="https://www.uniprot.org/diseases/DI-05667">
   Neurodevelopmental disorder with hypotonia and variable intellectual and behavioral abnormalities
  </a>
 </li>
 <li>
  <a href="https://www.uniprot.org/diseases/DI-05658">
   Neurodevelopmental disorder with structural brain anomalies and dysmorphic facies
  </a>
 </li>
 <li>
  <a href="https://www.uniprot.org/diseases/DI-05666">
...
<p>
 The UniProt
 <a href="https://www.uniprot.org/proteomes/">
  Proteomes portal
 </a>
...
<p>
 ...
 <a href="https://www.uniprot.org/help/assessing_proteomes">
  two metrics
 </a>
...
<p>
 ...
 <a href="https://www.uniprot.org/proteomes/UP000005640">
  UP000005640
 </a>
 .
</p>
