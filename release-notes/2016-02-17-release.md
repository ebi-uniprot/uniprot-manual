...
[Show all entries having a cross-reference to SwissPalm.](http://www.uniprot.org/uniprotkb?query=database%3Aswisspalm)
...
[Show all entries having a cross-reference to Gramene.](http://www.uniprot.org/uniprotkb?query=database:gramene)
