...
As of this release, [Mcr-1](http://www.uniprot.org/uniprotkb/A0A0R6L508) has been annotated and is available in UniProtKB/Swiss-Prot.
...
Example: [Q13530](http://www.uniprot.org/uniprotkb/Q13530)

[Show all entries having a cross-reference to SwissPalm.](http://www.uniprot.org/uniprotkb?query=database%3Aswisspalm&sort=score)

### Text format

Example: [Q13530](http://www.uniprot.org/uniprotkb/Q13530.txt)

    DR   SwissPalm; Q13530; -.

### XML format

Example: [Q13530](http://www.uniprot.org/uniprotkb/Q13530.xml)

    <dbReference type="SwissPalm" id="Q13530"/>

### RDF format

Example: [Q13530](http://www.uniprot.org/uniprotkb/Q13530.ttl)
...
Cross-references to Gramene may be isoform-specific. The general format of isoform-specific cross-references was described in release [2014_03](http://www.uniprot.org/release-notes/2014-03-19-release) .
...
Example: [Q10DK7](http://www.uniprot.org/uniprotkb/Q10DK7#sequences)

[Show all entries having a cross-reference to Gramene.](http://www.uniprot.org/uniprotkb?query=database:gramene&sort=score)

### Text format

Example: [Q10DK7](http://www.uniprot.org/uniprotkb/Q10DK7.txt)
...
Example: [Q10DK7](http://www.uniprot.org/uniprotkb/Q10DK7.xml)
...
Example: [Q10DK7](http://www.uniprot.org/uniprotkb/Q10DK7.ttl)
...
UniProt provides [sequence annotations](http://www.uniprot.org/help/sequence_annotation), a.k.a. protein features, to describe regions or sites of biological interest; [secondary structure regions](http://www.uniprot.org/help/structure_section), [domains](http://www.uniprot.org/help/domain), [post-translational modifications](http://www.uniprot.org/help/ptm_processing_section) and [binding sites](http://www.uniprot.org/help/binding) among others, play a critical role in the understanding of what the protein does. With the growth in biological data, integration and visualization becomes increasingly important for exposing different data aspects that might be otherwise hidden, unclear or difficult to grasp.
