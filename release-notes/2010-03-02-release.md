...
[Show all the entries having a cross-reference to SUPFAM.](http://www.uniprot.org/uniprotkb?query=database%3ASUPFAM)
...
[Show all the entries having a cross-reference to HOVERGEN.](http://www.uniprot.org/uniprotkb?query=database%3AHOVERGEN)
