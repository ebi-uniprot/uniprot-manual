...
As of this release, [HPF1, PARP1 and PARP2 entries](<http://www.uniprot.org/uniprotkb?query=(gene:hpf1+OR+gene:PARP1+OR+gene:PARP2)+AND+taxonomy:mammalia+AND+reviewed:true>) have been updated and are publicly available.
